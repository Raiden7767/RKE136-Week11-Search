...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=b200f8a206e25b65731194f24cb3fe63&query=${movieTitle}`;
    let genres = 'https://api.themoviedb.org/3/genre/movie/list?api_key=b200f8a206e25b65731194f24cb3fe63&language=en-US';
